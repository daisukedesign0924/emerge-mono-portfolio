...
function emono_admin_tab_profile($opts) {
    ...
    wp_localize_script( 'emerge-mono-admin', 'emonoSnsSettings', array(
        'i18n' => array(
            'placeholder'     => esc_attr__( 'e.g. X / Instagram', 'emerge-mono' ),
            'del'             => __( 'Delete', 'emerge-mono' ),
            'iconPlaceholder' => esc_attr__( 'Icon image URL (optional)', 'emerge-mono' ),
            'selectIcon'      => __( 'Select Icon', 'emerge-mono' ),
            'clear'           => __( 'Clear', 'emerge-mono' ),
            'mediaTitle'      => __( 'Select Icon Image', 'emerge-mono' ),
            'mediaButton'     => __( 'Use this image', 'emerge-mono' ),
        ),
    ) );
...
function emono_admin_tab_cpt($opts) {
    ...
    <form method="post" action="">
        ...
        <?php if ( function_exists( 'emono_render_post_type_visibility' ) ) { emono_render_post_type_visibility( $opts ); } ?>
