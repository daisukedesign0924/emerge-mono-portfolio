...
function emono_ed_admin_enqueue( $hook ) {
    ...
    wp_localize_script( 'ene-admin', 'ENE', array(
        ...
        'i18n'         => array(
            ...
            'change'           => __( 'Change', 'emerge-mono' ),
            'clickToSelect'    => __( 'Click to select an image', 'emerge-mono' ),
            'selectGallery'    => __( 'Select Gallery Images', 'emerge-mono' ),
            'add'              => __( 'Add', 'emerge-mono' ),
            'image'            => __( 'Image', 'emerge-mono' ),
            'enterTitle'       => __( 'Please enter a title.', 'emerge-mono' ),
            'submitting'       => __( 'Submitting...', 'emerge-mono' ),
            'failedSubmit'     => __( 'Failed to submit.', 'emerge-mono' ),
            'confirmDeletePost'=> __( 'Delete this post? This cannot be undone.', 'emerge-mono' ),
            'deleting'         => __( 'Deleting...', 'emerge-mono' ),
            'deleted'          => __( 'Deleted.', 'emerge-mono' ),
            'categoryAdded'    => __( 'Category added.', 'emerge-mono' ),
            'confirmDeleteCat' => __( 'Delete this category?', 'emerge-mono' ),
            'noCategoriesYet'  => __( 'No categories yet', 'emerge-mono' ),
            'categoryDeleted'  => __( 'Category deleted.', 'emerge-mono' ),
            'processing'       => __( 'Processing...', 'emerge-mono' ),
        ),
    ));
