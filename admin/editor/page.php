    ...
    <div class="ene-wrap">
        <div class="ene-header">
            <div class="ene-header-inner">
                <div class="ene-header-title">
                    <?php echo $edit_id ? __( 'Edit Post', 'emerge-mono' ) : __( 'New Post', 'emerge-mono' ); ?>
                </div>
            </div>
        </div>
        <?php if ( ! $edit_id ) : ?>
        ...
        <div class="ene-type-bar">
            <div class="ene-type-bar-label">
                <?php echo $type === 'works' ? __( '📂 Editing Works', 'emerge-mono' ) : __( '📰 Editing News', 'emerge-mono' ); ?>
            </div>
        </div>
        <?php endif; ?>
                ...
                <div class="ene-sidebar">
                    ...
                    <div class="ene-actions">
                        <button type="button" id="ene-submit" class="ene-submit-btn" onclick="eneSubmit()">
                            <?php echo $edit_id ? __( 'Update', 'emerge-mono' ) : __( 'Publish', 'emerge-mono' ); ?>
                        </button>
                        <?php if ($edit_id) : ?>
            ...
            <table class="ene-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="?page=ene-post&type=works&edit=<?php echo $post->ID; ?>" class="ene-table-btn"><?php esc_html_e( 'Edit', 'emerge-mono' ); ?></a>
            ...
            <table class="ene-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="font-size:12px;color:rgba(255,255,255,.3)"><?php echo get_the_date('Y.m.d', $post->ID); ?></td>
                        <td>
                            <a href="?page=ene-post&type=news&edit=<?php echo $post->ID; ?>" class="ene-table-btn"><?php esc_html_e( 'Edit', 'emerge-mono' ); ?></a>
                            <button class="ene-table-btn ene-delete-btn" onclick="eneDelete(<?php echo $post->ID; ?>, this)">Delete</button>
                        </td>
                    </tr>
                    <?php endforeach; ?>
...
function ene_page_create() {
    $em_pages = function_exists('en_get_em_page_defs') ? en_get_em_page_defs() : array(
        array( 'sc' => '[emerge_mono_top]',      'title' => 'Home',             'slug' => '',              'desc' => __( 'Top page — logo, site name, buttons', 'emerge-mono' ),      'icon' => '🏠' ),
    ...
    <div class="ene-wrap">
        <div class="ene-header">
            <div class="ene-header-inner">
                ...
                <a href="<?php echo esc_url( en_wizard_url() ); ?>" class="ene-back-btn"><?php esc_html_e( 'Open Setup Wizard', 'emerge-mono' ); ?></a>
                <?php endif; ?>
            </div>
        </div>
    ...
    var enePageI18n = {
        ...
        deleting:   <?php echo wp_json_encode( __( 'Deleting...', 'emerge-mono' ) ); ?>,
        deletedMsg: <?php echo wp_json_encode( '🗑 ' . __( 'Deleted "%s".', 'emerge-mono' ) ); ?>,
        del:        <?php echo wp_json_encode( __( 'Delete', 'emerge-mono' ) ); ?>,
        errorPrefix:<?php echo wp_json_encode( __( 'Error: ', 'emerge-mono' ) ); ?>,
        couldNotDelete: <?php echo wp_json_encode( __( 'Could not delete', 'emerge-mono' ) ); ?>,
        creating:   <?php echo wp_json_encode( __( 'Creating...', 'emerge-mono' ) ); ?>,
        createdMsg: <?php echo wp_json_encode( '✅ %s ' . __( 'created.', 'emerge-mono' ) ); ?>,
        create:     <?php echo wp_json_encode( __( 'Create', 'emerge-mono' ) ); ?>,
        couldNotCreate: <?php echo wp_json_encode( __( 'Could not create', 'emerge-mono' ) ); ?>
    };
        ...
        <div class="ene-body">
            ...
            <div class="ene-sidebar">
                ...
                <div class="ene-actions">
                    ...
                    <a href="<?php echo admin_url('admin.php?page=ene-page-create'); ?>" class="ene-cancel-btn"><?php esc_html_e( 'Cancel', 'emerge-mono' ); ?></a>
                </div>
