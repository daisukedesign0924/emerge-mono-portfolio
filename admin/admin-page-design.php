...
function emono_admin_tab_design($opts) {
    ...
    $fonts = array(
        'System Mono'   => 'System Monospace ' . __( '(default)', 'emerge-mono' ),
    ...
    <form method="post" action="">
        ...
        <div class="en-admin-section">
            ...
            <div class="en-field-desc">
                <?php esc_html_e( '* All fonts are system fonts or your uploaded font files. No external font service is used.', 'emerge-mono' ); ?>
            </div>
            ...
            wp_localize_script( 'emerge-mono-admin', 'emonoCustomFontSettings', array(
                ...
                'i18n'    => array(
                    'needBoth'    => __( 'Please enter a font name and select a file.', 'emerge-mono' ),
                    'adding'      => __( 'Adding...', 'emerge-mono' ),
                    'added'       => __( 'Font added.', 'emerge-mono' ),
                    'confirmDel'  => __( 'Delete this font?', 'emerge-mono' ),
                    'custom'      => __( 'Custom', 'emerge-mono' ),
                    'del'         => __( 'Delete', 'emerge-mono' ),
                    'mediaTitle'  => __( 'Select Font File', 'emerge-mono' ),
                    'mediaButton' => __( 'Use this font', 'emerge-mono' ),
                ),
            ) );
