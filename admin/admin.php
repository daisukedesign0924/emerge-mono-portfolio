...
require_once EN_PATH . 'admin/admin-page.php';
require_once EN_PATH . 'admin/admin-save.php';
require_once EN_PATH . 'admin/admin-style.php';
require_once EN_PATH . 'admin/setup-wizard.php';

add_action( 'admin_menu', 'en_register_admin_menu' );
function en_register_admin_menu() {
    // Emerge Mono 設定メニュー
    add_menu_page(
