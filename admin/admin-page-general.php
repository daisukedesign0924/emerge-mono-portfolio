...
function emono_admin_tab_general($opts) {
    ...
    <form method="post" action="" enctype="multipart/form-data">
        ...
        <div class="en-admin-section">
            <div class="en-admin-section-title"><?php esc_html_e( 'Top Page Layout', 'emerge-mono' ); ?></div>
            <div class="en-field-desc" style="margin-bottom:16px"><?php esc_html_e( 'Keep [emerge_mono_top] on your home page. Detailed top page editing has moved to the TOP Editor.', 'emerge-mono' ); ?></div>
            ...
            <a href="<?php echo esc_url( admin_url( 'admin.php?page=ene-top' ) ); ?>" class="en-admin-theme-btn" style="margin-top:16px">
                ...
                <span class="en-admin-theme-btn-label"><?php esc_html_e( 'Open TOP Editor', 'emerge-mono' ); ?></span>
            </a>
        </div>
        <div class="en-admin-section">
