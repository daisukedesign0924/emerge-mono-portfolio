    ...
    <form method="post" action="">
        ...
        <div class="en-admin-section">
            ...
            <div class="en-field-desc" style="margin-top:12px;padding:12px;background:rgba(255,255,255,.04);border-radius:4px;">
                ...
                <?php echo esc_html( sprintf( __( '* The display language follows the "%s" setting above.', 'emerge-mono' ), __( 'Display Language', 'emerge-mono' ) ) ); ?>
            </div>
        </div>
    ...
    (function(){
        ...
        function updatePreview() {
            ...
            fetch(ajaxurl, { method: 'POST', body: data })
                ...
                .then(function(res){
                    if (res.success) {
                        document.getElementById('en-privacy-preview').innerHTML = res.data;
                    }
                });
        }
        fields.forEach(function(name) {
