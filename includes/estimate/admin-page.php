...
function emono_admin_tab_estimate( $opts ) {
    ...
    wp_localize_script( 'en-estimate-admin', 'enEstAdminData', array(
        ...
        'i18n'         => array(
            'optionName'   => esc_attr__( 'Option name', 'emerge-mono-portfolio' ),
            'bankTransfer' => esc_attr__( 'e.g. Bank transfer', 'emerge-mono-portfolio' ),
            'del'          => __( 'Delete', 'emerge-mono-portfolio' ),
            'serviceName'  => esc_attr__( 'Service name (e.g. VTuber illustration)', 'emerge-mono-portfolio' ),
            'descOptional' => esc_attr__( 'Description (optional)', 'emerge-mono-portfolio' ),
            'optLabel'     => __( 'Option', 'emerge-mono-portfolio' ),
            'chkLabel'     => __( 'Check', 'emerge-mono-portfolio' ),
            'qtyLabel'     => __( 'Quantity', 'emerge-mono-portfolio' ),
            'itemName'     => esc_attr__( 'Item name (e.g. Number of characters)', 'emerge-mono-portfolio' ),
            'unitPrice'    => __( 'Unit price ¥', 'emerge-mono-portfolio' ),
            'minQty'       => __( 'Min qty', 'emerge-mono-portfolio' ),
            'addOption'    => __( '+ Add option', 'emerge-mono-portfolio' ),
            'plusOption'   => __( '+ Option', 'emerge-mono-portfolio' ),
            'plusCheck'    => __( '+ Check', 'emerge-mono-portfolio' ),
            'plusQuantity' => __( '+ Quantity', 'emerge-mono-portfolio' ),
        ),
    ) );
}
