...
function emono_shortcode_estimate( $atts ) {
    ...
    $btn_text        = emono_opt('contact_btn_text', __( 'Send', 'emerge-mono' ));
    $recaptcha_key   = emono_opt('recaptcha_site_key', '');
    $success_msg     = emono_opt('contact_success', __( 'Your message has been sent.', 'emerge-mono' ));
    ...
    $en_est_data = wp_json_encode( array(
        ...
        'i18n'           => array(
            'perUnit'       => __( 'each', 'emerge-mono' ),
            'perUnitPrefix' => __( 'each', 'emerge-mono' ),
            'currency'      => __( '¥', 'emerge-mono' ),
            'noFee'         => __( 'No fee', 'emerge-mono' ),
            'fee'           => __( 'Fee', 'emerge-mono' ),
            'feeLabel'      => __( 'fee', 'emerge-mono' ),
            'method'        => __( 'Method', 'emerge-mono' ),
            'estTotal'      => __( 'Estimated total', 'emerge-mono' ),
            'subtotal'      => __( 'Subtotal', 'emerge-mono' ),
