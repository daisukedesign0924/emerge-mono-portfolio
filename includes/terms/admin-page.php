...
function emono_admin_tab_terms( $opts ) {
    ...
    <?php
    // Terms preview script: external file + localized nonce (no inline PHP script).
    wp_enqueue_script( 'en-terms-admin', EMONO_URL . 'includes/terms/assets/terms-admin.js', array(), EMONO_VERSION, true );
    wp_localize_script( 'en-terms-admin', 'enTermsPreview', array(
        'nonce'   => wp_create_nonce( 'en_preview_terms' ),
